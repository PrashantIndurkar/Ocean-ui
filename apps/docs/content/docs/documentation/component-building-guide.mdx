...
description: A comprehensive checklist and guide for building new Ocean UI components
---

# Component Building Guide

This guide provides a step-by-step checklist for building new Ocean UI components that follow the copy-paste library pattern.
...
Here's the standard structure for a new component:
...
function ComponentName({ className, ...props }: ComponentProps<typeof ComponentPrimitive.Root>) {
  return (
...
function ComponentSubPart({ className, ...props }: ComponentProps<typeof ComponentPrimitive.SubPart>) {
  return (
...
2. Follow this checklist for each new component
3. Test thoroughly before submitting
4. Update documentation

For questions or help, refer to the [Installation Guide](/docs/documentation/how-to-install) or check existing component implementations.
