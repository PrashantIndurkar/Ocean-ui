...
<DocText>
  Ocean UI components use utility functions for merging Tailwind CSS classes and
  managing component variants. Install the required dependencies:
</DocText>
...
<DocText>
  ...
  conflicts and ensuring proper styling. The `class-variance-authority` package
  is used for managing component variants (like button sizes and styles).
</DocText>
