export function SolidJsLogo({ className }: { className?: string }) {
  return (
    <svg
      width="382.23"
      height="70.7"
    ...
    >
      ...
      <g>
        ...
        <path
          d="M75.81,15.35S50.86-3.49,31.5.91l-1.7.47A12.35,12.35,0,0,0,23.22,6a11.18,11.18,0,0,0-.71,1.18L15.36,19.33l12.35,2.41A22,22,0,0,0,45.32,25.2l22,4.3Z"
          fill="url(#solidjs-logo-gradient-a)"
          opacity="0.3"
